...
class Text {
	...
	public static function randomText( $length ) {
		 ...
		 for ( $i = 0; $i < $length; $i++ ) {
			$text .= $characters[rand( 0, 41 )];
		 }
		 return $text;
	}

	/**
	 * Replace associative array text
	 *
	 * @since  1.0.0
	 * @access public
	 * @access static
	 ...
	 * String position
	 *
	 * Finds position of first occurrence of substring
	 * in a string otherwise returns false.
	 *
	 * @since  1.0.0
	 * @access public
	 * @access static
	...
	/**
	 * Image relative to absolute path
	 *
	 * @since  1.0.0
	 * @access public
	 * @access static
	...
	/**
	 * HTML entities in code elements
	 *
	 * @since  1.0.0
	 * @access public
	 * @access static
	 ...
	 * Truncate string
	 *
	 * Truncates the string under the limit specified
