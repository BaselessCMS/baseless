...
// Activate a theme.
function activate_theme( $directory ) {
...
function ajax_response( $status = 0, $message = '', $data = [] ) {
...
*/
function transform_image( $file, $images, $thumbs = false ) {
...
function download_restricted_file( $file ) {
